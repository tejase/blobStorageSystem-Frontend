...
class ManageFile extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            AsyncSelect cacheOptions loadOptions = { this.loadOptions }
            defaultOptions onInputChange = { this.handleInputChange }
            onChange = { this.handleShareOptionSelect }
            selectedOption = { this.state.shareId }
            isClearable placeholder = "Select an email id" /
            >
            <
            Select isClearable = { true }
            options = {
...
export default (props) => {
    ...
    return <ManageFile history = { history }
