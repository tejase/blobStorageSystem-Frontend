...
class Login extends Component {
  ...
  submitForm = (e) => {
    ...
    axios
      .post(
        "https://murmuring-mountain-24156.herokuapp.com" + "/login",
        this.state.LoginFormValues
      )
      .then((response) => {
  ...
  render() {
    return (
      ...
      >
        <form
          style={{ border: "1px solid #000", padding: "40px" }}
          id="main-login"
        ...
        >
          ...
          <label>
            ...
            <input
              ...
              name="email"
              placeholder="Email"
              value={this.state.LoginFormValues.email}
          ...
          <label>
            ...
            <input
              ...
              value={this.state.LoginFormValues.password}
              onChange={this.handleChange}
            />
            <br />
          </label>
